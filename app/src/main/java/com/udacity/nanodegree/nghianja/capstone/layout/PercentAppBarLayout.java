 ...
 */
public class PercentAppBarLayout extends AppBarLayout {

    private final PercentLayoutHelper mHelper = new PercentLayoutHelper(this);

    public PercentAppBarLayout(Context context) {
        super(context);
    }

    public PercentAppBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
